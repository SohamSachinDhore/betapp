...
def create_working_main_gui():
    ...
    def create_time_table():
        ...
        with dpg.table(
            ...
            dpg.add_table_column(label="Customer", width=150)
            dpg.add_table_column(label="Bazar", width=80)
            dpg.add_table_column(label="Col 0", width=60)
            dpg.add_table_column(label="Col 1", width=60)
            dpg.add_table_column(label="Col 2", width=60)
            dpg.add_table_column(label="Col 3", width=60)
            dpg.add_table_column(label="Col 4", width=60)
            dpg.add_table_column(label="Col 5", width=60)
            dpg.add_table_column(label="Col 6", width=60)
            dpg.add_table_column(label="Col 7", width=60)
            dpg.add_table_column(label="Col 8", width=60)
            dpg.add_table_column(label="Col 9", width=60)
